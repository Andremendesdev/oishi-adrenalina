import { ABOUT_CONTENT } from "@/data/siteConfig";

export const About = () => {
  const { heading, headingLine2, paragraph2, stats } = ABOUT_CONTENT;
      ...
      <div className="container grid lg:grid-cols-12 gap-16 items-center">
        <div className="lg:col-span-5 reveal">
          ...
          <h2 className="mt-4 font-display text-5xl md:text-6xl leading-[1.05]">
            {heading}
            <br />
            <span className="italic text-gradient-red">{headingLine2}</span>
          </h2>
        </div>
        ...
        >
          <p className="text-lg leading-relaxed text-foreground/85 font-light">
            ...
            bar japonês reconhecido pela atmosfera única, sabor e modernidade.
